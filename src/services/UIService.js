...
(function() {
  ...
  window.UIService = class UIService {
    ...
    renderHeader() {
      console.log('📋 Rendering header with action buttons');
      return `
        <div class="n9n-header">
          ...
          <div style="display: flex; gap: 2px;">
            <button class="n9n-new-chat-btn" data-action="new-conversation" title="New Chat" style="background: none; border: none; color: #9ca3af; cursor: pointer; padding: 6px; border-radius: 4px; transition: all 0.2s;">
    ...
    renderChat(isAuthenticated, user, messages) {
      return `
        <div class="n9n-chat">
